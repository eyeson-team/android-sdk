...
object NetworkModule {
    ...
    /**
     * PEM file for 'ISRG Root X1' Root certificate (https://letsencrypt.org/certificates/#root-certificates)
     *
     * Needed for Android SDK version <= 25 due to expired certificates.
